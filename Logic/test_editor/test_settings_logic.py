...
def read_time():
    ...
    if hours == 0 and minutes == 0:
        show_error_dialog("Please set time limits", "You can set the time in the settings tab of the editor. Please note the the time format is HH:MM.")
        return None
...
def read_name():
    ...
    if name == "":
        show_error_dialog("Please name the test", "You can name the test in the settings tab of the editor.")
        return None
    return name