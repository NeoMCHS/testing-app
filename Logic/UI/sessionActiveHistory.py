...
################################################################################
## Form generated from reading UI file 'sessionActiveHistory.ui'
##
...
"border-color: rgb(192, 192, 192);")
        ...
        self.end_session_button = QPushButton(Form)
        self.end_session_button.setObjectName(u"end_session_button")
        self.end_session_button.setMinimumSize(QSize(100, 35))
        self.end_session_button.setMaximumSize(QSize(150, 35))
        self.end_session_button.setStyleSheet(u"background-color: rgb(255, 0, 0); color: rgb(0, 0, 0);")

        self.horizontalLayout.addWidget(self.end_session_button)
    ...
    def retranslateUi(self, Form):
        ...
        self.end_session_button.setText(QCoreApplication.translate("Form", u"End session", None))
    # retranslateUi
